...
#define STATUS_Mastr       1<<15|regSTATUSadd<<12|Drive_Mast_Setup.Sta.STDLAT<<7|Drive_Mast_Setup.Sta.STD<<6|Drive_Mast_Setup.Sta.UVLO<<5|Drive_Mast_Setup.Sta.BPDF<<4|Drive_Mast_Setup.Sta.APDF<<3|Drive_Mast_Setup.Sta.BOCP<<2|Drive_Mast_Setup.Sta.AOCP<<1|Drive_Mast_Setup.Sta.OTS
