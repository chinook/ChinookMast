...
//	Open timers
//%%%%%%%%%%%%%%%%%%%%%%%%%%%
  timerCounterValue = Timer.Open(TIMER_1, TIMER_GET_POS / TIMER_SCALE_MS, SCALE_MS);   // Timer used for regulating the mast (Period = 1000 ms) and getting the mast position (Period = 100 ms).
